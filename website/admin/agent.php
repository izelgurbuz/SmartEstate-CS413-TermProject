<?php session_start();
if(!isset($_SESSION['fullName']) || $_SESSION['fullName'] == "" || $_SESSION['uType'] !== "admin"){
...
<head>
    ...
    <title>Smart Estate Admin Portal</title>
                        ...
                        <div class="card">
                            <div class="header">
                                ...
                                <div class="content table-responsive table-full-width">
                                    ...
                                    <tbody>
                                    <?php 
                                    $results = mysqli_query($con,"SELECT * FROM users WHERE users.type='agent' LIMIT 10");
                                    ...
                                    foreach ($results as $result) {?>
                                        ...
                                        ?>
                                    <?php 
                                    $results = mysqli_query($con,"SELECT * FROM agents LIMIT 10");
                                    $fetch = mysqli_fetch_array($results, MYSQLI_ASSOC);
                                    foreach ($results as $result) {?>
                                        <tr>
                                            <td><?php echo $result['id'];?></td>
