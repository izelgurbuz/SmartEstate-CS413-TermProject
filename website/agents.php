	...
	<div class="container">
		<div class="row">
			<div class="col-md-12">
				...
				<span>Agent In <?php echo $fetch['city'];?></span>
		...
		<div class="col-md-12">
			<div class="agent agent-page">
				...
				<div class="agent-avatar">
					<img src="<?php echo $fetch['picture'];?>" alt="">
				</div>
				...
				<div class="agent-content">
					...
					<ul class="agent-contact-details">
						...
						<li><i class="fa fa-envelope-o "></i><a href="#"><span><?php echo $fetch['email'];?></span></a></li>
					</ul>
...
<div class="container">
	<div class="row sticky-wrapper">
		...
		<div class="col-lg-8 col-md-8">
			...
			<h4 class="headline">His/Her Listings</h4>
	...
	<div class="row">
			<div style="margin-top: 5%;" class="col-md-12">
				<div class="agent agent-page">
					...
					<div class="agent-content">
						<div class="agent-name">
							<h4><center>You should give the id of the corresponding Agent.</center></h4>
